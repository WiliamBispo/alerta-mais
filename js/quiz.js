const allQuestions = [
    {
      ...
      answers: [
        ...
        { text: "Ficar parado no local", correct: false, explanation: "Ficar parado facilita que a pessoa se aproxime. Ir para um local movimentado aumenta sua segurança." }
      ]
    },
    {
      ...
      answers: [
        ...
        { text: "Tentar abrir para ver o que é", correct: false, explanation: "Abrir objetos suspeitos pode ser perigoso, pois podem conter substâncias nocivas ou explosivos." }
      ]
    },
    {
      ...
      answers: [
        ...
        { text: "Andar com o celular na mão", correct: false, explanation: "Andar distraído com o celular pode tornar você um alvo fácil. Mantenha-se atento ao ambiente." }
      ]
    },
    {
      ...
      answers: [
        ...
        { text: "Carregar objetos de valor à vista", correct: false, explanation: "Mostrar objetos de valor pode atrair a atenção de pessoas mal-intencionadas." }
      ]
    },
    {
      question: "O que fazer ao presenciar um crime?",
      answers: [
        { text: "Intervir imediatamente", correct: false, explanation: "Intervir pode colocar sua segurança em risco. O melhor é avisar as autoridades." },
    ...
    },
    {
      ...
      answers: [
        { text: "Ignorar e continuar com sua rotina", correct: false, explanation: "Ignorar pode permitir que o crime aconteça. Fique atento e reporte o comportamento à segurança." },
    ...
    },
    {
      ...
      answers: [
        ...
        { text: "Reagir de forma agressiva", correct: false, explanation: "Reagir pode colocar sua vida em risco. O melhor é colaborar e manter a calma." }
      ]
    },
    {
      question: "Como agir ao perceber alguém te observando de forma constante?",
      answers: [
        { text: "Ignorar e continuar com suas atividades", correct: false, explanation: "Ignorar pode fazer com que você se torne um alvo. Fique atento e avalie a situação." },
    ...
    },
    {
      ...
      answers: [
        { text: "Tentar correr o mais rápido possível", correct: false, explanation: "Correr pode ser perigoso, especialmente se a pessoa estiver te seguindo. O melhor é procurar um lugar seguro e pedir ajuda." },
  ...
  function showResults() {
    ...
    resultElement.innerHTML = `
      ...
      ${mistakes.length > 0
        ? `<p><strong>Você cometeu os seguintes erros:</strong></p><ul>${mistakes.map(mistake => `
